          ...
          <ul>
              @if(auth()->user()->role === 'admin')
                  <li class="nav-item nav-item-has-children">
                      ...
                      <ul id="menuGestion" class="collapse dropdown-nav">
                          <li>
                              <a href="#">
                                  Clientes
                              </a>
              ...
              @if(auth()->user()->role === 'veterinario' || auth()->user()->role === 'admin')
                  <li class="nav-item nav-item-has-children">
                      ...
                      <ul id="menuVeterinaria" class="collapse dropdown-nav">
                          <li>
                              <a href="#">
                                  Citas
                              </a>
              ...
              @if(auth()->user()->role === 'cliente')
                  <li class="nav-item nav-item-has-children">
                      ...
                      <ul id="menuCliente" class="collapse dropdown-nav">
                          <li>
                              <a href="#">
                                  Mi perfil
                              </a>
          ...
          <div class="row">
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  Derechos de autor al que corresponda
